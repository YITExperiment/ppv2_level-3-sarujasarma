...
def toggle_eyes():
    current_color = c.itemcget(eye_1eft, 'fi11')
    new_color = c.body_color if current_color == 'white' else 'white'
    currant_state = c.itemcget(pupil_left, 'state')
    new_state = NORMAL if cunrent_state == HIDDEN else HIDDEN
    c.itemconfigure(pupil_left, state=new_state)
    c.itemconfigure(pupil_right, state=new_state)
    c.itemconfigure(eye_left,fil1=new_color)
...
ear_right = c.create_polygon(255, 45, 325, 10, 329, 70,
...
fill='white')
pupil_left = c.create_oval(148, 145,150, 155, outline='black',
fill='black')
eye_right = c.create_oval(230, 110, 260, 170, outline='black',
fill='white')
pupil_right = c.create_oval(240,145,250, 155, outline='black',
fill='black')
